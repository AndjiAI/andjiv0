...
const definition: SecretAgentDefinition = {
  ...
  spawnableAgents: [
    'andji/oss-model-file-picker@0.0.1',
    'andji/oss-model-researcher@0.0.1',
    'andji/oss-model-thinker@0.0.1',
    'andji/oss-model-reviewer@0.0.1',
    'andji/oss-model-coder@0.0.1',
  ],
...
{ANDJI_FILE_TREE_PROMPT}

{ANDJI_SYSTEM_INFO_PROMPT}

{ANDJI_GIT_CHANGES_PROMPT}`,
