...
const definition: AgentDefinition = {
  ...
  stepPrompt:
    'Continue the commit workflow: if needed, read relevant files for context; decide which files to stage and stage only related changes; draft a concise, imperative commit message focusing on why, then create a single commit including the Andji footer. Do not push and use end_turn when the commit is created.',
