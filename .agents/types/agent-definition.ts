/**
 * andji Agent Type Definitions
 *
 * This file provides TypeScript type definitions for creating custom Andji agents.
...
export interface AgentDefinition {
  ...
  /** Other agents this agent can spawn, like 'andji/file-picker@0.0.1'.
   *
   * Use the fully qualified agent id from the agent store, including publisher and version: 'andji/file-picker@0.0.1'
