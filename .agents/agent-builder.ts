...
const definition: AgentDefinition = {
  ...
  systemPrompt: [
    ...
    '',
    'You are an expert agent builder specialized in creating new agent templates for the andji system. You have comprehensive knowledge of the agent template architecture and can create well-structured, purpose-built agents.',
    '',
    ...
    '',
    'Here are the complete TypeScript type definitions for creating custom Andji agents:',
    '```typescript',
