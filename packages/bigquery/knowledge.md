...
This package provides integration with Google BigQuery for storing and analyzing Andji usage data.
...
- Production: `andji_data`
- Development: `andji_data_dev`
...
```typescript
import { setupBigQuery, insertTrace } from '@andji/bigquery'
