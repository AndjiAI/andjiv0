import type { andjiToolOutput } from '../../../common/src/tools/list'

export function runFileChangeHooks({
  files,
}: {
  files: string[]
}): Promise<andjiToolOutput<'run_file_change_hooks'>> {
  // In the SDK, we don't have access to andji.json configuration
