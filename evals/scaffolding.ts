...
import { runAgentStep } from '@andji/backend/run-agent-step'
import { assembleLocalAgentTemplates } from '@andji/backend/templates/agent-registry'
import { getFileTokenScores } from '@andji/code-map/parse'
import { TEST_USER_ID } from '@andji/common/old-constants'
import { mockModule } from '@andji/common/testing/mock-modules'
import { generateCompactId } from '@andji/common/util/string'
import { handleToolCall } from '@andji/npm-app/tool-handlers'
import { getSystemInfo } from '@andji/npm-app/utils/system-info'
...
} from '@andji/backend/websockets/websocket-action'
import type { ClientToolCall } from '@andji/common/tools/list'
import type {
  ToolResultOutput,
  ToolResultPart,
...
export function createFileReadingMock(projectRoot: string) {
  mockModule('@andji/backend/websockets/websocket-action', () => ({
