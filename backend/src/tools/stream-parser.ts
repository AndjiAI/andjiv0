import { toolNames } from '@andji/common/tools/constants'
...
import type { AgentState, Subgoal } from '@andji/common/types/session-state'
...
export async function processStreamWithTools<T extends string>(options: {
  ...
  const toolCalls: (andjiToolCall | CustomToolCall)[] = []
