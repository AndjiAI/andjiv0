...
export const handleStrReplace = ((params: {
  ...
  toolCall: andjiToolCall<'str_replace'>
  requestClientToolCall: (
    toolCall: ClientToolCall<'str_replace'>,
  ) => Promise<andjiToolOutput<'str_replace'>>
  ...
  result: Promise<andjiToolOutput<'str_replace'>>
...
}) satisfies andjiToolHandlerFunction<'str_replace'>
