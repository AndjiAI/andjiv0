...
export const handleWriteFile = (({
  ...
  toolCall: andjiToolCall<'write_file'>
  ...
  ) => Promise<andjiToolOutput<'write_file'>>
  ...
  result: Promise<andjiToolOutput<'write_file'>>
...
}) satisfies andjiToolHandlerFunction<'write_file'>
