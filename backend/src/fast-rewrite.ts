import { models, openaiModels } from '@andji/common/old-constants'
import { buildArray } from '@andji/common/util/array'
import { parseMarkdownCodeBlock } from '@andji/common/util/file'
import { generateCompactId, hasLazyEdit } from '@andji/common/util/string'
...
export const shouldAddFilePlaceholders = async (
  ...
  const fileWasPreviouslyEdited = messageHistory
    ...
    .some((m) => {
      const message = m as AndjiToolMessage<
