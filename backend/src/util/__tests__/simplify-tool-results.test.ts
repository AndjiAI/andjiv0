...
describe('simplifyReadFileResults', () => {
  it('should simplify read file results by omitting content', () => {
    const input: andjiToolOutput<'read_files'> = [
      {
        type: 'json',
        value: [
          {
  ...
  it('should not mutate the original input', () => {
    const originalInput: andjiToolOutput<'read_files'> = [
      {
        type: 'json',
        value: [
          {
...
describe('simplifyTerminalCommandResults', () => {
  ...
  it('should simplify terminal command results with stdout', () => {
    const input: andjiToolOutput<'run_terminal_command'> = [
      {
        type: 'json',
        value: {
          command: 'npm test',
  ...
  it('should not mutate the original input', () => {
    const originalInput: andjiToolOutput<'run_terminal_command'> = [
      {
        type: 'json',
        value: {
          command: 'npm test',
