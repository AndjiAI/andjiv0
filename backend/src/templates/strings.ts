import { andjiConfigSchema } from '@andji/common/json-config/constants'
import { escapeString } from '@andji/common/util/string'
...
export async function formatPrompt(
  ...
  const toInject: Record<PlaceholderValue, string> = {
    [PLACEHOLDER.AGENT_NAME]: agentTemplate
      ...
      : 'Buffy',
    [PLACEHOLDER.CONFIG_SCHEMA]: schemaToJsonStr(andjiConfigSchema),
