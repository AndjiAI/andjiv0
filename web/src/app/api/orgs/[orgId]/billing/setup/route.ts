...
export async function POST(req: NextRequest, { params }: RouteParams) {
  ...
  try {
    ...
    const checkoutSession = await stripeServer.checkout.sessions.create({
      ...
      success_url: `${env.NEXT_PUBLIC_andji_APP_URL}/orgs/${organization.slug}/billing/purchase?subscription_success=true`,
      cancel_url: `${env.NEXT_PUBLIC_andji_APP_URL}/orgs/${organization.slug}?subscription_canceled=true`,
      metadata: {
        organization_id: orgId,
