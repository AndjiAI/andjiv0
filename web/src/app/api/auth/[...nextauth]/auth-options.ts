...
import { processAndGrantCredit } from '@andji/billing'
...
import { DEFAULT_FREE_CREDITS_GRANT } from '@andji/common/old-constants'
import { getNextQuotaReset } from '@andji/common/util/dates'
import { generateCompactId } from '@andji/common/util/string'
import { stripeServer } from '@andji/common/util/stripe'
import { logSyncFailure } from '@andji/common/util/sync-failure'
import { loops, env } from '@andji/internal'
...
export const authOptions: NextAuthOptions = {
  ...
  providers: [
    GitHubProvider({
      clientId: env.ANDJI_GITHUB_ID,
      clientSecret: env.ANDJI_GITHUB_SECRET,
    }),
  ],
  session: {
    strategy: 'database',
