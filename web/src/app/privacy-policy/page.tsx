    ...
    <div className="max-w-6xl mx-auto">
      <main className="container mx-auto px-4 py-20 relative z-10">
        ...
        <div className="prose prose-stone dark:prose-invert max-w-none">
          ...
          <h2>Introduction</h2>
          <p>
            Welcome to andji, Inc. andji, Inc (“us”, “we”, or “our”)
            operates https://andji.com/ (hereinafter referred to as
            “Service”). Our Privacy Policy governs your visit to
            https://andji.com/, and explains how we collect, safeguard and
          ...
          <h2>Definitions</h2>
          <p>
            SERVICE means the https://andji.com/ website operated by
            andji, Inc PERSONAL DATA means data about a living individual who
          ...
          <h2>Use of Data</h2>
          <p>andji, Inc uses the collected data for various purposes:</p>
          <ul>
          ...
          <p>
            ...
            represents your agreement to that transfer. andji, Inc will take
          ...
          <p>By email: support@andji.com</p>
          <p>
          ...
          <p>
            andji, Inc uses remarketing services to advertise on third party
