...
import { CREDITS_REFERRAL_BONUS } from '@andji/common/old-constants'
import { getReferralLink } from '@andji/common/util/referral'
...
export function ReferralsSection() {
  ...
  return (
    <ProfileSection description="Share andji!">
      {data?.referredBy && (
              ...
              ({ data }) => (
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    >
                      <a
                        href={`https://andji.retool.com/form/e6c62a73-03b1-4ef3-8ab1-eba416ce7187?email=${session?.user?.email}`}
                        target="_blank"
