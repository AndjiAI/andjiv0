  ...
  return (
    <div className="relative">
      ...
      <Section background={SECTION_THEMES.hero.background} hero fullViewport>
        <div
          className={cn(
            'andji-container h-full flex flex-col transition-all duration-1000'
          )}
        >
      ...
      <div className={cn('transition-all duration-1000')}>
        ...
        {/* Prominent Claude Code vs andji Comparison - MOVED TO TOP */}
            ...
            >
              ...
              >
                <div className="bg-zinc-900/50 border-2 border-green-500/30 rounded-xl p-8 shadow-2xl shadow-green-500/10">
                  <Image
                    src="/andji-vs-claude-code.png"
                    alt="andji vs Claude Code Performance Comparison"
                    width={800}
                    height={600}
              ...
              <div className="mt-8">
                <motion.a
                  href="https://github.com/andjiAI/andji/tree/main/evals"
                  target="_blank"
        ...
        <FeatureSection
          ...
          description="andji deeply understands your entire codebase structure, dependencies, and patterns to generate code that other AI tools can't match."
        ...
        <FeatureSection
          ...
          description="Don't repeat yourself. andji can take notes on your conversations and stores them in human-readable markdown files. Each session teaches it about your specific needs and project setup."
