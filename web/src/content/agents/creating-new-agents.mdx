...
const definition: AgentDefinition = {
  ...
  spawnableAgents: ["andji/researcher@0.0.1"],  // Use full name for built-in agents
...
const definition: AgentDefinition = {
  ...
  spawnableAgents: ["andji/reviewer@0.0.1"],
...
**🎯 This is where andji agents become truly powerful!** While LLM-based agents work well for many tasks, programmatic agents give you precise control over complex workflows, while still letting you tap into LLMs when you want them.
...
const definition: AgentDefinition = {
  ...
  spawnableAgents: ["andji/thinker@0.0.1", "andji/reviewer@0.0.1"],
