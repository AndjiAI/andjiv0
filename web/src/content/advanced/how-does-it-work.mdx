---
title: 'How does andji actually work?'
section: 'advanced'
tags: ['introduction', 'faq']
order: 2
---

# How does andji actually work?

andji starts by running through the source files in all subdirectories and parsing them with tree-sitter. We use this information to help find relevant files to you requests.
