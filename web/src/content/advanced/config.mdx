...
andji can be configured using a `andji.json` file in your project root. This file allows you to customize various aspects of how andji operates in your project.

## Why configure andji?

Configuring andji helps you create a seamless development environment where andji becomes your central development hub. Instead of juggling multiple terminal windows and manually starting various services, you can let andji manage your entire development workflow.

### Startup Processes

You can configure startup processes, which will run in the background every time andji starts! When you use this feature, andji will automatically:
...
This means you can start your day with a single `andji` command, write code with andji's assistance, and when you're done, closing andji will cleanly shut down all your development processes. No more scattered terminal windows or forgotten running processes!
