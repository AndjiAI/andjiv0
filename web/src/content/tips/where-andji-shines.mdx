...
andji excels at rewriting and reorganizing code. Here are some examples of what it can do:
...
If you have projects with particular patterns and styles, andji can help you keep them consistent as you develop.

## Multi-file Edits

No more copy/paste! andji is particularly good at making changes that involve multiple files:
...
andji can help generate boilerplate code and common patterns:
...
andji can run terminal commands to help with development tasks:
...
andji maintains knowledge files (files ending in `knowledge.md`) that capture important context about your codebase:

- Project-specific patterns and conventions
- Architecture decisions and their rationale
- Best practices for different parts of the codebase

Feel free to update them as you see fit! andji will load your codebase's knowledge files every time it starts up, so it has full context into your project's unique needs and quirks.
