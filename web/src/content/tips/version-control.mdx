...
If andji makes a change you don't like, you can easily undo it:
...
andji works alongside your existing git workflow:
...
You can also use andji to create commit messages, just ask it to do so:
