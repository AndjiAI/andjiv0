...
andji uses knowledge files to store project-specific information and best practices. These files help andji understand your project's context and requirements.

## Getting Started

You can ask andji to create an initial knowledge file for your project:

```bash
    andji "Please create a knowledge.md file with initial project information"
```
...
You can specify commands that andji should run after making changes to verify everything still works. For example:
...
When these commands are specified in a knowledge file, andji will automatically run them after making changes to confirm the edits are valid.
