...
Use these commands inside andji:

- `login` to log into andji
...
When starting andji, you can use these flags to control the cost/quality tradeoff:
...
- Use andji like a terminal by entering terminal commands directly, like `cd backend` or `npm test`
