---
title: 'andji as an Engineer'
section: 'case-studies'
tags: ['productivity']
order: 2
---

# andji as an Engineer
...
But something clicked when Oliver tried andji. Not only did andji understood his codebase structure but it also respected his established patterns and libraries. The `knowledge.md` file he made contains details about the codebase and helps andji make better code edits. Even when andji wasn't perfect, he only had to do minor fixes—usually just adding a missing import or tweaking the structure slightly.

Oliver now spends less time on routine coding tasks and more on strategic planning with andji's help. When another developer joined the team, Oliver introduced them to andji, confident in its ability to maintain consistent coding standards across the project.

Finding the right AI coding assistant wasn't just about automating tasks—it was about finding a tool that could truly understand and adapt to a project's needs. andji helps Oliver focus on the important stuff and handle the rest. In the fast-paced world of startup development, that kind of reliability proves invaluable.
