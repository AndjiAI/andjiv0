...
export const testimonials: Testimonial[][] = [
  [
    ...
    {
      quote:
        'Yesterday at this time, I posted about testing andji for our dark → light mode conversion. Today at 10 AM, our new light design is live in production...',
    ...
    {
      quote:
        "One of my favorite parts of every day is hearing @brett_beatty giggle in awe at @andjiAI. We've been using it daily for a couple months now and it's still incredible 🤯",
    ...
    {
      quote:
        'Just did a complete structural refactoring that would have took 4-8 hours by a human in 30 minutes using Claude (Web) to drive andji to finish line. I think research in AI+AI pair programming is a must. ',
      author: 'Omar',
  ...
  [
    {
      quote:
        "I played around with andji and added some features to something I was working on. It really does have a different feeling than any other AI tools I've used; feels much more right, and I'm impressed by how you managed to land on that when nobody else did.",
    ...
    {
      quote:
        'andji is amazing; I use it over Claude for all my coding projects now',
      author: 'Janna Lu',
    ...
    {
      quote:
        'when investors ask me about andji I tell them i use it 6 days a week',
