...
const getInstallCommand = (pm: PackageManager): string => {
  switch (pm) {
    case 'yarn':
      return 'yarn global add andji'
    case 'pnpm':
      return 'pnpm add -g andji'
    case 'bun':
      return 'bun add -g andji'
    default:
      return 'npm install -g andji'
  }
}
...
export function OnboardingFlow({
  ...
  const [progress, setProgress] = useState<StepProgress>(() => {
    ...
    if (typeof window !== 'undefined') {
      const saved = localStorage.getItem('andji_onboarding_progress')
      if (saved) {
        try {
  ...
  const renderStep = () => {
    ...
    switch (currentStep) {
      case 0:
        return (
          <div className="space-y-4">
            <h3 className="text-xl font-semibold">Welcome to andji! 🎉</h3>
            <p className="text-muted-foreground">
              Let's get you set up with andji in just a few quick steps. This
      ...
      case 2:
        return (
          <div className="space-y-4">
            <h3 className="text-xl font-semibold">Install andji</h3>
            <p className="text-muted-foreground">
              Now let's install the andji CLI tool globally on your system.
            </p>
      ...
      case 4:
        return (
          <div className="space-y-4">
            ...
            <p className="text-muted-foreground">
              Navigate to the directory where you want to use andji. This
      ...
      case 5:
        return (
          <div className="space-y-4">
            <h3 className="text-xl font-semibold">Run andji</h3>
            <p className="text-muted-foreground">
              Now run the andji command to start the AI assistant in your
            ...
            <div className="bg-zinc-800/60 border border-zinc-700/50 hover:border-[#00FF9580] hover:shadow-[0_0_15px_#00FF9540] rounded-md overflow-hidden relative px-3 py-2.5 flex items-center justify-between transition-all duration-300 cursor-pointer group">
              ...
              <EnhancedCopyButton value="andji" />
            </div>
          </div>
        )
      ...
      case 6:
        return (
          <div className="space-y-4">
            ...
            <p className="text-muted-foreground">
              andji will open your browser to connect your CLI to your
              account.
            </p>
      ...
      default:
        return (
          <div className="space-y-4 text-center">
            ...
            <p className="text-muted-foreground">
              andji is now connected to your account. You can close this
              window.
            </p>
