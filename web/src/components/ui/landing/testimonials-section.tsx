  ...
  return (
    <Section background={SECTION_THEMES.testimonials.background}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          Watch them rave about andji (previously &quot;Manicode&quot;)
        </span>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-8">
        <div className="flex flex-col md:flex-row items-center justify-center md:space-x-12 space-y-8 md:space-y-0">
          <div className="flex flex-col items-center">
            ...
            <Link
              href="https://www.ycombinator.com/companies/andji"
              target="_blank"
              className="block"
            >
              <img
          ...
          <a
            href="https://www.producthunt.com/posts/andji?embed=true&utm_source=badge-featured&utm_medium=badge&utm_souce=badge-andji"
            target="_blank"
            className="block"
          >
            <img
              src="https://api.producthunt.com/widgets/embed-image/v1/featured.svg?post_id=501055&theme=dark"
              alt="andji - Better code generation than Cursor, from your CLI | Product Hunt"
              width="250"
              height="54"
            />
          </a>
