      ...
      <div className="andji-container">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
          <div>
            <Link href="/" className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-lg font-medium">andji</span>
            </Link>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link
                  href="https://github.com/andjiAI/andji"
                  target="_blank"
        ...
        <div className="border-t border-zinc-800 pt-8 flex flex-col md:flex-row justify-between items-center">
          <div className="text-sm text-zinc-500 mb-4 md:mb-0">
            &copy; {new Date().getFullYear()} andji. All rights reserved.
          </div>
