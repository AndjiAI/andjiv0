...
export function IDEDemo({ className }: IDEDemoProps) {
  ...
  useEffect(() => {
    ...
    const messages = [
      'andji will read and write files in "/Users/me/projects/your-next-app". Type "help" for commands.',
        ...
        >
                ...
                >
                  <div className="flex relative z-0">
                    ...
                    <div className="text-zinc-300">
                      ...
                      <span className="text-green-400">"Hello, andji!"</span>
                      <span>);</span>
                    </div>
                  </div>
          ...
          {showOriginalTerminal && (
            ...
            >
              ...
              >
                <TerminalOutput>
                  <span className="text-green-400 underline">andji:</span>{' '}
