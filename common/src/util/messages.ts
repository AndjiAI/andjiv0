...
import type {
  ...
  ToolMessage,
  UserMessage,
} from '../types/messages/andji-message'
...
function assistantToandjiMessage(
...
> {
  ...
  if (message.role === 'assistant') {
    ...
    return message.content.map((c) => {
      return assistantToandjiMessage({
        ...message,
        content: c,
      })
    })
  ...
  return toolToandjiMessage(message)
}
