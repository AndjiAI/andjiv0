...
export const andjiConfigFile = 'andji.json'
export const andjiConfigFileBackup = 'andji.jsonc'
...
export const andjiConfigSchema = z
  .object({
    description: z
      .any()
      .optional()
  ...
  .describe(
    `Defines the overall andji configuration file (e.g., ${andjiConfigFile}). This schema defines the top-level structure of the configuration. This schema can be found at https://www.andji.com/config`,
  )
...
/**
 * TypeScript type representing a validated andji configuration object.
 * This type is inferred from the `andjiConfigSchema` and provides type safety
 * for the entire configuration structure.
 */
export type andjiConfig = z.infer<typeof andjiConfigSchema>
