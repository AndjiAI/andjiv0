 ...
 *
 *  Run your agent with:
 *  > andji --agent git-committer
 *
 *  Or, run andji normally, and use the '@' menu to mention your agent, and andji will spawn it for you.
 *
 *  Finally, you can publish your agent with 'andji publish your-custom-agent' so users from around the world can run it.
 */
