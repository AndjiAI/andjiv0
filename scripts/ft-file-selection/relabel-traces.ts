import { promptFlashWithFallbacks } from '@andji/backend/llm-apis/gemini-with-fallbacks'
import { promptAiSdk } from '@andji/backend/llm-apis/vercel-ai-sdk/ai-sdk'
import { messagesWithSystem } from '@andji/backend/util/messages'
import { getTracesWithoutRelabels, insertRelabel } from '@andji/bigquery'
import { models, TEST_USER_ID } from '@andji/common/old-constants'
import { generateCompactId } from '@andji/common/util/string'

import type { System } from '../../backend/src/llm-apis/claude'
import type { GetRelevantFilesPayload } from '@andji/bigquery'
...
const DATASET = isProd ? 'andji_data' : 'andji_data_dev'
